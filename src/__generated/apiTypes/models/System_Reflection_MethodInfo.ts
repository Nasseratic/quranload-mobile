...
import type { System_Reflection_ICustomAttributeProvider } from './System_Reflection_ICustomAttributeProvider';
...
import type { System_Reflection_ParameterInfo } from './System_Reflection_ParameterInfo';
import type { System_RuntimeMethodHandle } from './System_RuntimeMethodHandle';
import type { System_Type } from './System_Type';

export type System_Reflection_MethodInfo = {
    ...
    returnParameter?: System_Reflection_ParameterInfo;
    returnType?: System_Type;
    returnTypeCustomAttributes?: System_Reflection_ICustomAttributeProvider;
};
