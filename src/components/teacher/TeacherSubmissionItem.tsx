...
interface Props {
  submission: Frontend.Content.Submission;
  onPress?: () => void;
}

const TeacherSubmissionItem = ({ submission, onPress }: Props) => {
  const handedInColor = useMemo(() => {
    if (submission.submittedAtDate) return Colors.Success[1];
      ...
      >
        ...
        <Stack flexDirection="row" gap="$1" alignItems="center">
          <Typography type="CaptionHeavy" style={{ color: handedInColor }}>
            {submission.submittedAtDate ? "Handed in" : "Not handed in"}
          </Typography>
          {submission.submittedAtDate && (
            <>
              ...
              <Typography
                type="CaptionHeavy"
                style={{
                  color: submission.isFeedbackGiven ? Colors.Success[1] : Colors.Error[1],
                }}
              >
                Feedback
              </Typography>
...
export default TeacherSubmissionItem;
